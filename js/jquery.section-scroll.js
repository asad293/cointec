    ...
    $.fn.sectionScroll = function (options) {
      ...
      $sections.each(function () {
        ...
        if($section_number == 1 || $section_number == 7) {
          xx = " style=\"opacity: 0; pointer-events: none;\"";
        }

        var bullet_title = settings.titles ? '<span>' + title + '</span>' : '';

        bullets_html += '<li' + xx + '><a title="' + title + '" href="#scrollto-section-' + $section_number + '">' + bullet_title + '</a></li>';
