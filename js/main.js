(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($(window).width() > 768) {
            ...
            var anim2tl2 = new TimelineMax({repeat: -1, delay: 6});
            anim2tl2.to(graph2, 12, {x: -790, ease: Linear.easeNone});

            var anim2tl6 = new TimelineMax({});
            anim2tl6.to(graph3, 12, {x: -350, ease: Linear.easeNone});

            var anim2tl3 = new TimelineMax({repeat: -1, delay: 3.2, repeatDelay: 2.5});
            anim2tl3.set([point1, firstCircle], {opacity: 0})
                ...
                .fromTo(green1, 3, {drawSVG: "100% 100%", ease: Linear.easeNone}, {
                    drawSVG: "0% 100%",
            ...
            var anim2tl4 = new TimelineMax({repeat: -1, delay: 5.8, repeatDelay: 5.5});
            ...
            var anim2tl7 = new TimelineMax({repeat: -1, delay: 3.2, repeatDelay: 2.5});
            anim2tl7.set(green2, {drawSVG: "0%"})
                .fromTo(green2, 3, {drawSVG: "100% 100%", ease: Linear.easeNone}, {
                    drawSVG: "0% 100%",
                    ease: Linear.easeNone
                }, 0)
            ...
            var anim2tl5 = new TimelineMax({repeat: -1, delay: 9.8, repeatDelay: 6});
        ...
        function addMailingListSubscription(emailAddress,errorContainer) {
            ...
            $.ajax({
                ...
                statusCode: {
                    ...
                    422: function() {
                        errorContainer.text("You have already Subscribed!");
                    }
                }
            });
        ...
        $('#input-early-access-btn').click(function () {
            if (isEmail($('#input-early-access').val())) {
                //call
                addMailingListSubscription($('#input-early-access').val(),$('#error-message-input-early-access'));
        ...
        $('#bottom-input-early-access-btn').click(function () {
            if (isEmail($('#bottom-input-early-access').val())) {
                //call
                addMailingListSubscription($('#bottom-input-early-access').val(),$('#error-message-bottom-input-early-access'));
