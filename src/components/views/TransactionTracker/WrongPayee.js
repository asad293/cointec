...
import { abandonOrder, getStatus } from '../../../Redux/actions'
...
class WrongPayee extends Component {
	...
	render() {
        ...
        <p className="mt-3 mb-5">
          <Link to='/'>Contact Faster Payments</Link>
        </p>
			</div>
		)
	}
...
export default connect(({ order }) => ({ order }), { abandonOrder, getStatus })(WrongPayee)
