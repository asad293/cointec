...
import { fetchAccounts, abandonOrder, refundPayment, getStatus } from '../../../Redux/actions'
      ...
      <div>
        ...
        <div className="row mt-4">
          <div className="col-12">
            <button className="btn btn-success w-100" onClick={this.handleSubmit}>
        ...
        <p className="text-center mt-2 mb-0" style={{visibility: this.props.order.abandon ? 'visible' : 'hidden'}}>Account details submitted, thank you.</p>
        <p className="text-center mt-2"><Link to='/'>Return to dashboard</Link></p>
      </div>
    )
  }
...
export default reduxForm({ form: 'WrongPaymentForm' })(
  connect(mapStateToProps, { fetchAccounts, abandonOrder, refundPayment, getStatus })(WrongPaymentForm)
)
