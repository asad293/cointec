	...
	render() {
		return (
			<div className="learn-page">
				<ReactTitle title="Privacy Policy | Cointec" />
    ...
    <div className="container pb-5">
        <div className="row d-flex justify-content-center">
            <div className="col-lg-8 col-md-12 privacy">
                ...
                <p>Cointec Ltd, hereafter referred to as “we”, “the platform” or simply “Cointec”, is legally required to process your (the data subject’s) personal information in accordance with Data Protection Act 2018 and the European Union’s General Data Protection Act.</p>
                ...
                <ul>
                    <li>Log Information, including your browser type, access times, IP address, pages viewed and your geolocation.</li>
                    <li>Device Information, including your device’s hardware model, operating system and version.</li>
                </ul>
                <p>We collect this information to analyse our user demographic and to monitor suspicious activity.</p>
                ...
                <h6>2. Storage of personal information</h6>
                ...
                <p>In accordance with the legislation presented below we are required to keep a record of your personal information, copies of identity documents and details of transactions for a period of five years from the date of your final transaction or account closure.</p>
                ...
                <h6>3. Control over your data</h6>
                <h6 className="sub-heading">Accessing your data</h6>
                ...
                <h6 className="sub-heading">Updating your data</h6>
                <p>You may request at any time, via e-mail or our website dashboard to update the personal information held about you by us.</p>
